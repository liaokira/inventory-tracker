...
export default function LocationColumn({ 
  ...
  return (
    <div className="flex flex-col min-w-[300px] max-w-[350px] bg-zinc-100 dark:bg-zinc-900 rounded-lg p-4 shadow-lg">
      {/* Column Title */}
      <div className="mb-4 pb-3 border-b-2 border-zinc-300 dark:border-zinc-700 flex justify-between items-center">
        <h2 
